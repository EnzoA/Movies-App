namespace SAL
{
	internal static class ServicesManagerConfig
	{
		...
		public static readonly string BASE_URL = "https://api.themoviedb.org/3/movie/";

		public static readonly string TMDB_API_CONFIGURATION_URL = $"https://api.themoviedb.org/3/configuration?api_key={API_KEY}";

		public static readonly string MOVIE_GROUPS_BASE_URL = $"{BASE_URL}{{0}}?api_key={API_KEY}&language={{1}}&page={{2}}";
